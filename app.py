...
simply we have to pass all these parameters in the send_email() function . and then we have imported two things : first is out smtplib which is simplr mail transfer protocol, and secondly i have imported config file. In  config, sender's email and pass will be there.and then simply we have to use some of the inbuilt function of smtp. then we can do it easily.